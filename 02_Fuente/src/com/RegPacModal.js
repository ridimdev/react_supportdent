...
import { Row,Col,Button, Modal, ModalHeader, ModalBody, ModalFooter,Label,Input,FormGroup,Form,CustomInput} from 'reactstrap';
import db from '../FirestoreConfig';
import moment from 'moment';
import './listarpacientes.css'

export default class RegPacModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      modal:false
...
guardar(e){
  ...
  render() {
      ...
      return (   
      <div>
        <Button color='info' onClick={this.toggle}>Nuevo</Button>
